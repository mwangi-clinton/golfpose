...
vis_backends = [
    ...
    dict(type='WandbVisBackend', init_kwargs=dict(project='golfpose', name='person_mobilenetv2_golfer_256x192', group='golfswing_person'))
]
visualizer = dict(
    type='PoseLocalVisualizer', vis_backends=vis_backends, name='person_mobilenetv2_golfer_256x192')
