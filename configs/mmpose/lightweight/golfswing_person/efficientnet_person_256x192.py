...
param_scheduler = [
    ...
    dict(type='MultiStepLR', begin=0, end=200, milestones=[30, 50], gamma=0.1,
         by_epoch=True),
]
...
vis_backends = [
    ...
    dict(type='WandbVisBackend', init_kwargs=dict(project='golfpose', name='person_efficientnet_golfer_256x192', group='golfswing_person'))
]
visualizer = dict(
    type='PoseLocalVisualizer', vis_backends=vis_backends, name='person_efficientnet_golfer_256x192')
